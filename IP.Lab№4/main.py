...
# Gabor Filter
def Gabor_filter(K_size=111, Sigma=1.5, Gamma=1.2, Lambda=3, Psi=0, angle=0):
    # get half size
    d = K_size // 2
...
def Gabor_filtering(gray, K_size=111, Sigma=1.5, Gamma=1.2, Lambda=3, Psi=0, angle=0):
    # get shape
    H, W = gray.shape
...
def Gabor_process(img):
    ...
    for i, A in enumerate(As):
        # gabor filtering
        _out = Gabor_filtering(gray, K_size=111, Sigma=1.5, Gamma=1.2, Lambda=3, angle=A)
